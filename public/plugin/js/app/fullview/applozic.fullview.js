...
(function($applozic, w, d) {
    ...
    function Applozic(appOptions) {
        ...
        function MckMessageService() {
            ...
            var $newConversation = $applozic("#newConversation");
            ...
            $applozic("#newConversation").click(function() {
                $("#newissue").removeClass("hide").addClass("show");
                
            });
            $applozic("#newissuesubmit").click(function() {
            var issuetitle = $("#issuetitle").val();
            var issuedesc = $("#issuedesc").val();
            _this.newConversation(issuetitle,issuedesc);
            });
            
            _this.newConversation = function(issuetitle,issuedesc) {    
               var message="Title: "+ issuetitle +"\nDescription: "+issuedesc;
                $applozic.fn.applozic('createGroup', {
                    'groupName' : issuetitle,
                    'admin':'applozic-premium',
                    'type': 2,
                    'users' : [ {
                        userId : 'applozic-premium',
                        displayName : 'Applozic Premium Support',
                    ...
                    'callback' : function(response) {           
                        ...
                        $("#newissue").removeClass("show").addClass("hide");
                        $('#issue')[0].reset();
                        var messagePxy={};
                        messagePxy.groupId = response.data.clientGroupId;  
                        messagePxy.message = message;      
            ...
            _this.getGroup = function(params) {
                ...
                $applozic.each(params.users, function(i, user) {
                    if (typeof user.userId !== 'undefined') {
                        if (typeof user.groupRole === 'undefined' ) {
